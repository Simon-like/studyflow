...
export function CreateGroupCard({ onClick }: CreateGroupCardProps) {
  return (
    <div onClick={onClick} className="bg-warm rounded-2xl p-5 border-2 border-dashed border-mist flex flex-col items-center justify-center text-center cursor-pointer hover:border-coral transition-all group">
